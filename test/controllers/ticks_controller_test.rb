...
class TicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tick" do
    assert_difference('Tick.count') do
      post ticks_url, params: { tick: { cliente_id: @tick.cliente_id, conteudo: @tick.conteudo, pedido_id: @tick.pedido_id, titulo: @tick.titulo } }
    end
  ...
  test "should update tick" do
    patch tick_url(@tick), params: { tick: { cliente_id: @tick.cliente_id, conteudo: @tick.conteudo, pedido_id: @tick.pedido_id, titulo: @tick.titulo } }
